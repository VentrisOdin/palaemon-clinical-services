...
function EarWaxRemovalPetersfield() {
  return (
    <section className="home-section">
      <div className="container" style={{ maxWidth: "900px" }}>
        ...
        >
          <p className="home-eyebrow">Petersfield</p>
          ...
          <p className="home-section-copy" style={{ marginBottom: "1rem" }}>
            ...
            Petersfield, with microsuction carried out where appropriate. The
            service is designed for people who would prefer to be seen at home,
          ...
          >
            ...
            >
              Home visits are available across Petersfield and nearby areas,
              making ear care more accessible for those who prefer treatment in
          ...
          <div style={{ marginBottom: "2rem" }}>
            ...
            <p className="home-section-copy" style={{ marginBottom: "1rem" }}>
              This page focuses on Petersfield, but appointments may also be
              available in surrounding areas such as Liss, Clanfield, Horndean
              and Midhurst depending on scheduling.
            </p>
...
export default EarWaxRemovalPetersfield;
...
function EarWaxRemovalPortsmouth() {
  return (
    <section className="home-section">
      <div className="container" style={{ maxWidth: "900px" }}>
        ...
        >
          <p className="home-eyebrow">Portsmouth</p>
          ...
          <p className="home-section-copy" style={{ marginBottom: "1rem" }}>
            ...
            Portsmouth, with microsuction carried out where appropriate. The
            service is designed for people who would prefer treatment in the
            comfort of their own home, without the need to travel or sit in a
            waiting room.
          </p>
          ...
          >
            ...
            >
              Home visits are available across Portsmouth and nearby areas,
              making ear care more convenient for people who may find travel
              difficult or would simply prefer to be seen at home.
            </div>
          </div>
          ...
          <div style={{ marginBottom: "2rem" }}>
            ...
            <p className="home-section-copy" style={{ marginBottom: "1rem" }}>
              This page is focused on Portsmouth, but appointments may also be
              available in nearby areas such as Southsea, Cosham, Havant and
              Waterlooville depending on scheduling.
            </p>

            <Link to="/service-area-hampshire" className="home-link">
...
export default EarWaxRemovalPortsmouth;